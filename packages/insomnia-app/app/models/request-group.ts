...
export function update(requestGroup: RequestGroup, patch: $Shape<RequestGroup> = {}): Promise<RequestGroup> {
...
export async function duplicate(requestGroup: RequestGroup, patch: $Shape<RequestGroup> = {}): Promise<RequestGroup> {
  if (!patch.name) {
