...
export function update(workspaceMeta: WorkspaceMeta, patch: $Shape<WorkspaceMeta> = {}): Promise<WorkspaceMeta> {
  return db.docUpdate(workspaceMeta, patch);
}

export async function updateByParentId(workspaceId: string, patch: {
  [key: string]: any;
