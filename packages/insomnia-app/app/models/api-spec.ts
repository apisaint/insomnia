...
export async function getOrCreateForParentId(workspaceId: string, patch: $Shape<ApiSpec> = {}): Promise<ApiSpec> {
...
export async function updateOrCreateForParentId(workspaceId: string, patch: $Shape<ApiSpec> = {}): Promise<ApiSpec> {
