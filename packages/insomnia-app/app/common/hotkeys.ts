...
function keyComb(ctrl: boolean, alt: boolean, shift: boolean, meta: boolean, keyCode: number): KeyCombination {
  return {
    ctrl: ctrl,
    alt: alt,
    shift: shift,
...
function keyBinds(mac: KeyCombination | Array<KeyCombination>, winLinux: KeyCombination | Array<KeyCombination>): KeyBindings {
...
const defaultRegistry: HotKeyRegistry = {
  [hotKeyRefs.WORKSPACE_SHOW_SETTINGS.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.comma.keyCode), keyComb(true, false, true, false, keyboardKeys.comma.keyCode)),

  [hotKeyRefs.REQUEST_SHOW_SETTINGS.id]: keyBinds(keyComb(false, true, true, true, keyboardKeys.comma.keyCode), keyComb(true, true, true, false, keyboardKeys.comma.keyCode)),

  [hotKeyRefs.PREFERENCES_SHOW_KEYBOARD_SHORTCUTS.id]: keyBinds(keyComb(true, false, true, true, keyboardKeys.forwardslash.keyCode), keyComb(true, false, true, false, keyboardKeys.forwardslash.keyCode)),

  [hotKeyRefs.PREFERENCES_SHOW_GENERAL.id]: keyBinds(keyComb(false, false, false, true, keyboardKeys.comma.keyCode), keyComb(true, false, false, false, keyboardKeys.comma.keyCode)),

  [hotKeyRefs.TOGGLE_MAIN_MENU.id]: keyBinds(keyComb(false, true, false, true, keyboardKeys.comma.keyCode), keyComb(true, true, false, false, keyboardKeys.comma.keyCode)),

  [hotKeyRefs.REQUEST_QUICK_SWITCH.id]: keyBinds(keyComb(false, false, false, true, keyboardKeys.p.keyCode), keyComb(true, false, false, false, keyboardKeys.p.keyCode)),

  [hotKeyRefs.SHOW_RECENT_REQUESTS.id]: keyBinds(keyComb(true, false, false, false, keyboardKeys.tab.keyCode), keyComb(true, false, false, false, keyboardKeys.tab.keyCode)),

  [hotKeyRefs.SHOW_RECENT_REQUESTS_PREVIOUS.id]: keyBinds(keyComb(true, false, true, false, keyboardKeys.tab.keyCode), keyComb(true, false, true, false, keyboardKeys.tab.keyCode)),

  [hotKeyRefs.PLUGIN_RELOAD.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.r.keyCode), keyComb(true, false, true, false, keyboardKeys.r.keyCode)),

  [hotKeyRefs.SHOW_AUTOCOMPLETE.id]: keyBinds(keyComb(true, false, false, false, keyboardKeys.space.keyCode), keyComb(true, false, false, false, keyboardKeys.space.keyCode)),

  [hotKeyRefs.REQUEST_SEND.id]: keyBinds([keyComb(false, false, false, true, keyboardKeys.enter.keyCode), keyComb(false, false, false, true, keyboardKeys.r.keyCode), keyComb(false, false, false, false, keyboardKeys.f5.keyCode)], [keyComb(true, false, false, false, keyboardKeys.enter.keyCode), keyComb(true, false, false, false, keyboardKeys.r.keyCode), keyComb(false, false, false, false, keyboardKeys.f5.keyCode)]),

  [hotKeyRefs.REQUEST_SHOW_OPTIONS.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.enter.keyCode), keyComb(true, false, true, false, keyboardKeys.enter.keyCode)),

  [hotKeyRefs.ENVIRONMENT_SHOW_EDITOR.id]: keyBinds(keyComb(false, false, false, true, keyboardKeys.e.keyCode), keyComb(true, false, false, false, keyboardKeys.e.keyCode)),

  [hotKeyRefs.ENVIRONMENT_SHOW_SWITCH_MENU.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.e.keyCode), keyComb(true, false, true, false, keyboardKeys.e.keyCode)),

  [hotKeyRefs.REQUEST_TOGGLE_HTTP_METHOD_MENU.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.l.keyCode), keyComb(true, false, true, false, keyboardKeys.l.keyCode)),

  [hotKeyRefs.REQUEST_TOGGLE_HISTORY.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.h.keyCode), keyComb(true, false, true, false, keyboardKeys.h.keyCode)),

  [hotKeyRefs.REQUEST_FOCUS_URL.id]: keyBinds(keyComb(false, false, false, true, keyboardKeys.l.keyCode), keyComb(true, false, false, false, keyboardKeys.l.keyCode)),

  [hotKeyRefs.REQUEST_SHOW_GENERATE_CODE_EDITOR.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.g.keyCode), keyComb(true, false, true, false, keyboardKeys.g.keyCode)),

  [hotKeyRefs.SIDEBAR_FOCUS_FILTER.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.f.keyCode), keyComb(true, false, true, false, keyboardKeys.f.keyCode)),

  [hotKeyRefs.SIDEBAR_TOGGLE.id]: keyBinds(keyComb(false, false, false, true, keyboardKeys.backslash.keyCode), keyComb(true, false, false, false, keyboardKeys.backslash.keyCode)),

  [hotKeyRefs.RESPONSE_FOCUS.id]: keyBinds(keyComb(false, false, false, true, keyboardKeys.singlequote.keyCode), keyComb(true, false, false, false, keyboardKeys.singlequote.keyCode)),

  [hotKeyRefs.SHOW_COOKIES_EDITOR.id]: keyBinds(keyComb(false, false, false, true, keyboardKeys.k.keyCode), keyComb(true, false, false, false, keyboardKeys.k.keyCode)),

  [hotKeyRefs.REQUEST_SHOW_CREATE.id]: keyBinds(keyComb(false, false, false, true, keyboardKeys.n.keyCode), keyComb(true, false, false, false, keyboardKeys.n.keyCode)),

  [hotKeyRefs.REQUEST_QUICK_CREATE.id]: keyBinds(keyComb(false, true, false, true, keyboardKeys.n.keyCode), keyComb(true, true, false, false, keyboardKeys.n.keyCode)),

  [hotKeyRefs.REQUEST_SHOW_DELETE.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.delete.keyCode), keyComb(true, false, true, false, keyboardKeys.delete.keyCode)),

  [hotKeyRefs.REQUEST_SHOW_CREATE_FOLDER.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.n.keyCode), keyComb(true, false, true, false, keyboardKeys.n.keyCode)),

  [hotKeyRefs.REQUEST_SHOW_DUPLICATE.id]: keyBinds(keyComb(false, false, false, true, keyboardKeys.d.keyCode), keyComb(true, false, false, false, keyboardKeys.d.keyCode)),

  [hotKeyRefs.REQUEST_TOGGLE_PIN.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.p.keyCode), keyComb(true, false, true, false, keyboardKeys.p.keyCode)),

  [hotKeyRefs.CLOSE_DROPDOWN.id]: keyBinds(keyComb(false, false, false, false, keyboardKeys.esc.keyCode), keyComb(false, false, false, false, keyboardKeys.esc.keyCode)),

  [hotKeyRefs.CLOSE_MODAL.id]: keyBinds(keyComb(false, false, false, false, keyboardKeys.esc.keyCode), keyComb(false, false, false, false, keyboardKeys.esc.keyCode)),

  [hotKeyRefs.ENVIRONMENT_UNCOVER_VARIABLES.id]: keyBinds(keyComb(false, true, true, false, keyboardKeys.u.keyCode), keyComb(false, true, true, false, keyboardKeys.u.keyCode)),

  [hotKeyRefs.SHOW_SPEC_EDITOR.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.s.keyCode), keyComb(true, false, true, false, keyboardKeys.s.keyCode)),

  [hotKeyRefs.SHOW_TEST.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.t.keyCode), keyComb(true, false, true, false, keyboardKeys.t.keyCode)),

  [hotKeyRefs.SHOW_MONITOR.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.m.keyCode), keyComb(true, false, true, false, keyboardKeys.m.keyCode)),

  [hotKeyRefs.SHOW_HOME.id]: keyBinds(keyComb(false, false, true, true, keyboardKeys.h.keyCode), keyComb(true, false, true, false, keyboardKeys.h.keyCode)),

  [hotKeyRefs.FILTER_DOCUMENTS.id]: keyBinds(keyComb(false, false, false, true, keyboardKeys.f.keyCode), keyComb(true, false, false, false, keyboardKeys.f.keyCode))
};
...
export function areSameKeyCombinations(keyComb1: KeyCombination, keyComb2: KeyCombination): boolean {
  return (keyComb1.alt === keyComb2.alt && keyComb1.shift === keyComb2.shift && keyComb1.ctrl === keyComb2.ctrl && keyComb1.meta === keyComb2.meta && keyComb1.keyCode === keyComb2.keyCode);
}
...
export function isModifierKeyCode(keyCode: number): boolean {
  return (keyCode === keyboardKeys.alt.keyCode || keyCode === keyboardKeys.shift.keyCode || keyCode === keyboardKeys.ctrl.keyCode || // Meta keys.
  keyCode === keyboardKeys.leftwindowkey.keyCode || keyCode === keyboardKeys.rightwindowkey.keyCode || keyCode === keyboardKeys.selectkey.keyCode);
}
 ...
 */
export function constructKeyCombinationDisplay(keyComb: KeyCombination, mustUsePlus: boolean): string {
  const {
    ctrl,
    alt,
    shift,
 ...
 */
export function getHotKeyDisplay(hotKeyDef: HotKeyDefinition, hotKeyRegistry: HotKeyRegistry, mustUsePlus: boolean) {
