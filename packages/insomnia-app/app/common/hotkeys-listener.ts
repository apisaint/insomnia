...
import { HotKeyDefinition, KeyBindings, KeyCombination } from "./hotkeys";
 ...
 */
export async function pressedHotKey(e: KeyboardEvent, definition: HotKeyDefinition): Promise<boolean> {
 ...
 */
export async function executeHotKey(e: KeyboardEvent, definition: HotKeyDefinition, callback: (...args: Array<any>) => any): Promise<void> {
