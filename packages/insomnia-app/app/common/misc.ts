...
import { GlobalActivity } from "./constants";
...
export function filterParameters<T extends Parameter>(parameters: Array<T>, name: string): Array<T> {
...
export function keyedDebounce(callback: (...args: Array<any>) => any, millis: number = DEBOUNCE_MILLIS): (...args: Array<any>) => any {
  let timeout;
  let results = {};
...
export function debounce(callback: (...args: Array<any>) => any, millis: number = DEBOUNCE_MILLIS): (...args: Array<any>) => any {
...
export function nullFn(): void {// Do nothing
}
...
export function fuzzyMatch(searchString: string, text: string, options: {splitSpace?: boolean;loose?: boolean;} = {}): null | {score: number;indexes: Array<number>;} {
  return fuzzyMatchAll(searchString, [text], options);
}

export function fuzzyMatchAll(searchString: string, allText: Array<string>, options: {splitSpace?: boolean;loose?: boolean;} = {}): null | {score: number;indexes: Array<number>;} {
