...
import { CHECK_FOR_UPDATES_INTERVAL, getAppVersion, getAppId, isDevelopment, UPDATE_URL_MAC, UPDATE_URL_WINDOWS } from "../common/constants";
...
async function getUpdateUrl(force: boolean): Promise<string | null> {
  ...
  const params = [{ name: 'v', value: getAppVersion() }, { name: 'app', value: getAppId() }, { name: 'channel', value: settings.updateChannel }];
